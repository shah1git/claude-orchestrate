...
| Availability | `availability.fallbacks`, `availability.breaker`, `availability.midflight`, `availability.lead` | unavailability ≠ failure; sideways-or-up fallbacks; provider breaker; mid-flight death re-dispatches without burning attempts; quota forecast per wave; resume-pack after each wave |
