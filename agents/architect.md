...
- **Delivery (v2.16, corrects v2.15):** your design/plan is your **final message** as
  text — do not write it to a report file (the harness blocks subagent report files). The
  lead dispatches you **synchronously** so that text arrives as the tool result and a
  lossy background relay can't drop it.
